...
conn = sqlite3.connect('Full_Database_Backend/Full_Database_Backend.db')  # Establish a connection to a SQLite database
...
with open('Full_Database_Backend/Full_Database_Backend.json', 'w', encoding='utf-8') as f:
